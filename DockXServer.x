...
-(NSDictionary *)getAutoCorrectionValue:(NSString *)name withUserInfo:(NSDictionary *)userInfo{
    ...
    return @{@"value":[NSNumber numberWithBool:[[%c(UIKeyboardPreferencesController) sharedPreferencesController] boolForKey:7]]};
}

-(NSDictionary *)setAutoCorrectionValue:(NSString *)name withUserInfo:(NSDictionary *)userInfo{
    BOOL value = [userInfo[@"value"] boolValue];
    [[%c(UIKeyboardPreferencesController) sharedPreferencesController] setValue:[NSNumber numberWithBool:value] forKey:7];
    [[%c(UIKeyboardPreferencesController) sharedPreferencesController] synchronizePreferences];
...
-(NSDictionary *)getAutoCapitalizationValue:(NSString *)name withUserInfo:(NSDictionary *)userInfo{
    [[%c(UIKeyboardPreferencesController) sharedPreferencesController] synchronizePreferences];
    return @{@"value":[NSNumber numberWithBool:[[%c(UIKeyboardPreferencesController) sharedPreferencesController] boolForKey:8]]};
}
...
-(NSDictionary *)setAutoCapitalizationValue:(NSString *)name withUserInfo:(NSDictionary *)userInfo{
    ...
    //[[%c(UIKeyboardPreferencesController) sharedPreferencesController] setValue:[NSNumber numberWithBool:value] forKey:8];
    //[[%c(UIKeyboardPreferencesController) sharedPreferencesController] synchronizePreferences];
    CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFSTR("AppleKeyboardsSettingsChangedNotification"), NULL, NULL, YES);
