...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        PSSpecifier *entryTitle = [PSSpecifier preferenceSpecifierNamed:LOCALIZED(@"TEXT") target:self set:@selector(setValue:specifier:) get:@selector(readValue:) detail:nil cell:PSEditTextCell edit:@YES];
        ...
        PSSpecifier *entryTitleLP = [PSSpecifier preferenceSpecifierNamed:LOCALIZED(@"TEXT") target:self set:@selector(setValue:specifier:) get:@selector(readValue:) detail:nil cell:PSEditTextCell edit:@YES];
