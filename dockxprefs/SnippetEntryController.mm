...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        PSSpecifier *entryTitle = [PSSpecifier preferenceSpecifierNamed:LOCALIZED(@"SHELL_TITLE") target:self set:@selector(setValue:specifier:) get:@selector(readValue:) detail:nil cell:PSEditTextCell edit:@YES];
        ...
        PSSpecifier *entryCommand = [PSSpecifier preferenceSpecifierNamed:LOCALIZED(@"SHELL_COMMAND") target:self set:@selector(setValue:specifier:) get:@selector(readValue:) detail:nil cell:PSEditTextCell edit:@YES];
        ...
        PSSpecifier *entryTitleLP = [PSSpecifier preferenceSpecifierNamed:LOCALIZED(@"SHELL_TITLE") target:self set:@selector(setValue:specifier:) get:@selector(readValue:) detail:nil cell:PSEditTextCell edit:@YES];
        ...
        PSSpecifier *entryCommandLP = [PSSpecifier preferenceSpecifierNamed:LOCALIZED(@"SHELL_COMMAND") target:self set:@selector(setValue:specifier:) get:@selector(readValue:) detail:nil cell:PSEditTextCell edit:@YES];
